function solve() {
    ...
    Catalog = (function () {
        ...
        Catalog.prototype.findById = function (options) {
    ...
    BookCatalog = (function (Parent) {
        ...
        BookCatalog.prototype.add = function (book) {
            Parent.prototype.add.call(this, book);
        };

        BookCatalog.prototype.findById = function (book) {
            Parent.prototype.findById.call(this, book);
        };        
    ...
    MediaCatalog = (function (Parent) {
        ...
        MediaCatalog.prototype._validateItem = function (media) {
            return Parent.prototype._validateItem.call(this, media) &&
        ...
        MediaCatalog.prototype.add = function (book) {
            Parent.prototype.add.call(this, book);
        };

        MediaCatalog.prototype.findById = function (book) {
            Parent.prototype.findById.call(this, book);
        };              
...
book = module.getBook('mimisbook', '1234567890', 'esoteric', 'esoteric');
media = module.getMedia('mimisvideo', 3, 4, 'Inconvinient truth');
bookCatalog = module.getBookCatalog('bookCatalog');
bookCatalog.add(book);
// console.log(bookCatalog);

var result = bookCatalog.findById(1);
//should return an array with properties of the searched book

result = bookCatalog.findById(2);
// should return undefined

mediaCatalog = module.getMediaCatalog('mediaCatalog');
mediaCatalog.add(media);
mediaCatalog.getSortedByDuration();